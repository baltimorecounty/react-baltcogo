    ...
    try {
      ...
      if (response.data.HasErrors) {
        ...
        try {
          const error =
            errorsReturned ===
            "Sorry! The email address submitted is already taken." ? (
              <p>
                The email address you entered is already registered in this
                system. <Link to="SignInForm">Log in to your account</Link> or{" "}
