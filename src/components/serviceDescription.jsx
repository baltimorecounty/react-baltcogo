...
const ServiceDescription = ({ requestType, errorsServiceDescription, touchedServiceDescription, pageFieldName, }) => {
			...
			{(requestType === 'website issue') ?
				<div className={
					...
					<Field
						...
						className={errorsServiceDescription && touchedServiceDescription ? "text-select error" : null}
					/>
