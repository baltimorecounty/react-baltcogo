			...
			<Form>
				{(localProps.requiresLocation === false) ?
					<div name="ContactInfo" >
						...
						<div className={
							rest.formik.errors.NameFirst && rest.formik.touched.NameFirst ? "cs-form-control error" : "cs-form-control"}>
						...
						<div className={
							rest.formik.errors.NameLast && rest.formik.touched.NameLast ? "cs-form-control error" : "cs-form-control"}>
						...
						<div className={
							rest.formik.errors.Email && rest.formik.touched.Email ? "cs-form-control error" : "cs-form-control"}>
							<label htmlFor="Email"
						...
						<div className={
							rest.formik.errors.Telephone && rest.formik.touched.Telephone ? "cs-form-control error" : "cs-form-control"}>
					...
					<div id="ContactAddress">
						...
						<div className={
							rest.formik.errors.streetAddress && rest.formik.touched.streetAddress ? "cs-form-control error" : "cs-form-control"}>
						...
						<div className={
							rest.formik.errors.city && rest.formik.touched.city ? "cs-form-control error" : "cs-form-control"}>
							<label htmlFor="city"
						...
						<div className={
							rest.formik.errors.zipCode && rest.formik.touched.zipCode ? "cs-form-control error" : "cs-form-control"}>
